  ...
  return (
    <div>
      <div className="container-fluid mt-5 ">
        <div className="row mt-5 " data-aos="zoom-in-left" style={{backgroundColor:"rgba(275,275,275,0.5)"}} ><h1  className='text-primary text-center  p-4 'data-aos="fade-down" >Customer Reviews</h1></div>
...
<p className='text-white' >GoMechanics-Hub, Islamabad</p>
            ...
            <h5 className='text-center mt-5 mb-4 ' style={{color:" #7f7fe4"}} > It is definitely GoMechanic for me</h5>
                <p className='text-white' >
...
<div><Facebook className='tm-3 fa-3x'style={{color:" #7f7fe4"}} /> <span style={{color:" #7f7fe4"}} > Sameed khan</span></div>
<p className='text-white' >Facebook</p>
<h5 style={{color:" #7f7fe4"}} >Workshop Name</h5>
