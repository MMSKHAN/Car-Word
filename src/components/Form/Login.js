...
function Login() {
  ...
  <div className="form-group row gx-0 ">
    ...
    <div className="form-group row flex-column text-center" >
      <div className="col-sm-4 mt-3 mb-3 align-self-center "> <button className="btn btn-primary btn-md btn-block ">Login</button> </div>
      <div className="col-sm-4 align-self-center mt-2 mb-2   " style={{color:"black"}} > <Link to={"/"} className="nav-link" >  Sign up </Link></div> 
      <div className='col-sm-5 align-self-center mb-2 ' ><h6 style={{color:"blue"}} > <Link to={"/"} className="nav-link" > Forgot Password </Link></h6> </div>
    </div>
