...
function Gallary(props) {
  ...
  return (
    <>
    <div className="container-fluid bramdsgallary">
    <div className="row">
{Brands.map((item)=>{
  return(
    
    <div className="col-sm-1 bg-white mt-3 " ><img src={item.pic} alt="pictures" style={{height:"50px",width:"50px"}} /></div>
  )
})}
</div>
    </div>
    ...
    <div className="container mt-5 mb-5">
      ...
      <div className="row justify-content-center  ">
        <div className="col-md-4 mx-auto  ">
          <div className='d-flex border bg-white border-dark'>
