        ...
        <div className="row gx-0 mt-5 mb-5 ">
            <div className="col-md-6 bg-white gx-0 " data-aos='slide-right'  >
                <div className="row gx-0">
                    <a href='/' className="col-md-6 border gx-0 buycev border-dark"data-aos='flip-up' >
                    ...
                    <a href='/' className="col-md-6 border buycev border-dark "> 
                ...
                <a href='/' className="row gx-0 "data-aos='flip-up'>
                    <div className="col-md-6 border gx-0 buycev border-dark ">
